...
<!-- logo -->
<img src="/src/assets/readme/studyhub.webp" width="400" />
...
<img src="/docs/screenshots/01-noLoginHeader.png" width="32%"/> <img src="/docs/screenshots/02-mainSection.png" width="32%"/> <img src="/docs/screenshots/03-main.png" width="32%"/>
<img src="/docs/screenshots/04-main.png" width="32%"/> <img src="/docs/screenshots/05-main.png" width="32%"/> <img src="/docs/screenshots/06-main.png" width="32%"/>

#### 채팅 & 알람

<img src="/docs/screenshots/07-chat.png" width="32%"/> <img src="/docs/screenshots/08-chat.png" width="32%"/> <img src="/docs/screenshots/09-chat.png" width="32%"/>
<img src="/docs/screenshots/10-notification.png" width="32%"/> <img src="/docs/screenshots/11-notification.png" width="32%"/> <img src="/docs/screenshots/12-notification.png" width="32%"/>

#### 일반 로그인

<img src="/docs/screenshots/13-login.png" width="32%"/> <img src="일반로그인_2단계_URL" width="32%"/> <img src="일반로그인_3단계_URL" width="32%"/>

#### 회원가입

<img src="/docs/screenshots/14-signup.png" width="32%"/> <img src="/docs/screenshots/15-signup.png" width="32%"/>

#### 이메일 찾기

<img src="/docs/screenshots/16-emailFind.png" width="32%"/> <img src="/docs/screenshots/17-emailFind.png" width="32%"/> <img src="/docs/screenshots/18-emailFind.png" width="32%"/>

#### 비밀번호 찾기

<img src="/docs/screenshots/19-pwdFind.png" width="32%"/> <img src="/docs/screenshots/20-pwdFind.png" width="32%"/> <img src="/docs/screenshots/21-pwdFind.png" width="32%"/>

#### 탈퇴 회원 복구

<img src="/docs/screenshots/22-userLeave.png" width="32%"/> <img src="/docs/screenshots/23-userLeave.png" width="32%"/> <img src="/docs/screenshots/24-userLeave.png" width="32%"/>
...
<img src="/docs/screenshots/25-myProfile.png" width="32%"/> <img src="/docs/screenshots/26-myProfile.png" width="32%"/> <img src="/docs/screenshots/27-myProfile.png" width="32%"/>

#### 비밀번호 변경

<img src="/docs/screenshots/28-pwdChange.png" width="32%"/>

#### 회원 탈퇴

<img src="/docs/screenshots/29-userLeaveActive.png" width="32%"/> <img src="/docs/screenshots/30-userLeaveActive.png" width="32%"/> <img src="/docs/screenshots/31-userLeaveActive.png" width="32%"/>

#### 북마크한 공고

<img src="/docs/screenshots/32-bookmarkJobs.png" width="48%"/>

#### 북마크한 강의

<img src="/docs/screenshots/33-bookmarkCourse.png" width="48%"/>

#### 지원 내역

<img src="/docs/screenshots/34-studyApplication.png" width="48%"/> <img src="/docs/screenshots/35-studyApplication.png" width="32%"/>

#### 완료된 스터디

<img src="/docs/screenshots/36-completedStudy.png" width="48%"/> <img src="/docs/screenshots/37-completedStudy.png" width="48%"/>
...
- [FE 2팀 시연 영상](https://)
- [FE 2팀 문서](https://www.notion.so/2aa62196b3f8804ba466ff442c5b3427)
...
<tr>
    <td align="center" width="25%">
        <a href="https://github.com/mminseop">
            <img src="https://github.com/mminseop.png" width="120px;" alt="김민섭" style="border-radius:50%"/><br />
            <sub><b>김민섭</b> (리드)</sub><br/>
            <sub>@mminseop</sub>
        </a>
        <br/><br/>
        <sub>프로젝트 총괄<br>마이페이지</sub>
    </td>
    <td align="center" width="25%">
        <a href="https://github.com/hyeonseo1109">
            <img src="https://github.com/hyeonseo1109.png" width="120px;" alt="민현서" style="border-radius:50%"/><br />
            <sub><b>민현서</b></sub><br/>
            <sub>@hyeonseo1109</sub>
        </a>
        <br/><br/>
        <sub>알림/채팅<br/>이메일/비밀번호 찾기</sub>
    </td>
    <td align="center" width="25%">
        <a href="https://github.com/seun9yoon">
            <img src="https://github.com/seun9yoon.png" width="120px;" alt="정승윤" style="border-radius:50%"/><br />
            <sub><b>정승윤</b></sub><br/>
            <sub>@seun9yoon</sub>
        </a>
        <br/><br/>
        <sub>로그인<br/>회원가입, 소셜로그인</sub>
    </td>
    <td align="center" width="25%">
        <a href="https://github.com/kim-mijin">
            <img src="https://github.com/kim-mijin.png" width="120px;" alt="김미진" style="border-radius:50%"/><br />
            <sub><b>김미진</b></sub><br/>
            <sub>@kim-mijin</sub>
        </a>
        <br/><br/>
        <sub>랜딩페이지<br/>회원탈퇴복구</sub>
    </td>
</tr>
</table>
...
4. GitHub에서 Pull Request 생성 (develop <- feat)
5. 코드 리뷰 및 승인 후 merge
6. merge 완료된 feat 브랜치는 삭제
...
- Axios 인스턴스는 `api/client.ts`에서 중앙 관리
...
- `useQuery`를 컴포넌트에서 바로 사용하지 않고 별도 커스텀 훅으로 관리
...
- `hanlers`는 배열에 스프레드 오퍼레이터로 등록

### Communication Rules

- **Discord**와 **Notion** 활용한 비동기 협업
...
![TypeScript](https://img.shields.io/badge/TypeScript-95.9%25-3178C6?style=flat-square&logo=typescript&logoColor=white)
![JavaScript](https://img.shields.io/badge/JavaScript-3.4%25-F7DF1E?style=flat-square&logo=javascript&logoColor=black)
![Other](https://img.shields.io/badge/Other-0.7%25-808080?style=flat-square)
