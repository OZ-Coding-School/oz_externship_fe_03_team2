...
| 랜딩 페이지                | 채팅                       | 알림                       |
| -------------------------- | -------------------------- | -------------------------- |
| ![랜딩](https://eeeee.com) | ![채팅](https://eeeee.com) | ![알림](https://eeeee.com) |

| 일반 로그인                      | 카카오 소셜 로그인           | 네이버 소셜 로그인           |
| -------------------------------- | ---------------------------- | ---------------------------- |
| ![일반로그인](https://eeeee.com) | ![카카오](https://eeeee.com) | ![네이버](https://eeeee.com) |

| 회원가입                       | 이메일 찾기                      | 비밀번호 찾기                  | 탈퇴 회원 복구                     |
| ------------------------------ | -------------------------------- | ------------------------------ | ---------------------------------- |
| ![회원가입](https://eeeee.com) | ![이메일찾기](https://eeeee.com) | ![비번찾기](https://eeeee.com) | ![탈퇴회원복구](https://eeeee.com) |

### 마이페이지

| 내 정보 수정                   | 비밀번호 변경                  | 회원 탈퇴                  |
| ------------------------------ | ------------------------------ | -------------------------- |
| ![정보수정](https://eeeee.com) | ![비번변경](https://eeeee.com) | ![탈퇴](https://eeeee.com) |

| 북마크한 공고                    | 북마크한 강의                    |
| -------------------------------- | -------------------------------- |
| ![북마크공고](https://eeeee.com) | ![북마크강의](https://eeeee.com) |

| 지원 내역                      | 완료된 스터디                    |
| ------------------------------ | -------------------------------- |
| ![지원내역](https://eeeee.com) | ![완료스터디](https://eeeee.com) |
...
| [@mminseop](https://github.com/mminseop) | [@hyeonseo1109](https://github.com/hyeonseo1109) | [@seun9yoon](https://github.com/seun9yoon) | [@kim-mijin](https://github.com/kim-mijin) |
| ---------------------------------------- | ------------------------------------------------ | ------------------------------------------ | ------------------------------------------ |
| 김민섭                                   | 민현서                                           | 정승윤                                     | 김미진                                     |
| 마이페이지                               | 알림/채팅, 이메일/비밀번호 찾기                  | 로그인, 회원가입, 소셜로그인               | 랜딩페이지, 회원탈퇴복구                   |
...
- ![TypeScript](https://img.shields.io/badge/TypeScript-95.5%-blue?style=flat-square)
- ![JavaScript](https://img.shields.io/badge/JavaScript-3.8%-yellow?style=flat-square)
- ![Other](https://img.shields.io/badge/Other-0.7%25-purple?style=flat-square)
