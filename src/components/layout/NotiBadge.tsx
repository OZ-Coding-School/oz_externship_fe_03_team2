...
export function NotiBadge() {
  ...
  return (
    <div>
      <div className="bg-primary-500 fixed right-4 bottom-4 flex h-[3.5rem] w-[3.5rem] items-center justify-center rounded-full text-white shadow-[0_5px_10px_#00000040] lg:right-5 lg:bottom-5 lg:h-[3.7rem] lg:w-[3.7rem]">
