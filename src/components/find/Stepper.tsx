...
//         </div>
//         <div
//           className={`${getCircleColor(2)} h-[.25rem] w-[1.5rem] rounded-full lg:w-[4.6669rem]`}
//         ></div>
//         <div
...
//         </div>
//         <div
//           className={`${getCircleColor(3)} h-[.25rem] w-[1.5rem] rounded-full lg:w-[4.6669rem]`}
//         ></div>
//         <div
...
//       <div className="flex w-full items-center justify-between text-[.75rem] text-gray-500">
//         <p>정보입력</p>
//         <p>휴대폰인증</p>
//         <p>결과확인</p>
//       </div>
...
//         </div>
//         <div
//           className={`${getCircleColor(2)} h-[.25rem] max-w-[4.6669rem] flex-1 rounded-full`}
//         ></div>
//         <div
//           className={`${getCircleColor(2)} flex h-[2rem] w-[2rem] items-center justify-center rounded-full p-2 text-[.875rem] ${getTextColor(2)}`}
//         >
...
//         </div>
//         <div
//           className={`${getCircleColor(3)} h-[.25rem] max-w-[4.6669rem] flex-1 rounded-full`}
//         ></div>
//         <div
//           className={`${getCircleColor(3)} flex h-[2rem] w-[2rem] items-center justify-center rounded-full p-2 text-[.875rem] ${getTextColor(3)}`}
//         >
...
//         <p>휴대폰인증</p>
//         <p>결과확인</p> */}
//       <div className="flex w-full flex-1/4 items-center justify-around text-[.75rem] text-gray-500">
//         <p>정보입력</p>
//         <p>휴대폰인증</p>
//         <p>결과확인</p>
//       </div>
